...
public class CustomerService implements ICustomerService{
    ...
    static {
        ...
        customers.put(3,new Customer(3,"Alex","alex@codegym.vn","Hanoi"));
        customers.put(4,new Customer(4,"Adam","adam@codegym.vn","Beijin"));
        customers.put(5,new Customer(5,"John","john@codegym.vn","Miami"));
        customers.put(6,new Customer(6,"John","john@codegym.vn","New york"));
    }
    @Override
